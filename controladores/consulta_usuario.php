...
if (isset($_GET['buscar'])) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        header("Location: ../vista/consultar_eventos_usuarios.php?message=ok&resultados=" . urlencode($data));
        exit();
    } else {
        header("Location: ../vista/consultar_eventos_usuarios.php?message=vacio");
        exit();
    }
} else {
    header("Location: ../vista/consultar_eventos_usuarios.php?message=Escribe un criterio para buscar");
    exit();
}
